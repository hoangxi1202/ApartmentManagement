...
public class ApartmentDAO {
    ...
    /*"UPDATE Apartment_View\n"
            + "SET size =?, details = ?, buildingName = ?, rentPrice = ?, salePrice=?, status = ?\n"
            + "WHERE apartmentId = ?";
     */
    public List<ApartmentDTO> getListApartment_AD(String search) throws SQLException {
    ...
    public boolean updateApartment(ApartmentDTO apartment) throws SQLException {
        ...
        try {
            ...
            if (conn != null) {
                ...
                ptm.setString(3, apartment.getImage());
                ...
                ptm.setString(7, apartment.getApartmentId());
